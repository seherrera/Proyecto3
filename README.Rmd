...
```
#Data mal asignada
ya asignadas las categorias compararemos los datos inciales con los datos que se pudieron predecir y almacenaremos los mal clasificados en data_error para despues desplegar en pantalla cuantos datos estan mal etiquetados
